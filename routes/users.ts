...
import userEntity = require("./entitys/UserEntity");
import requestEntity = require("./constracts/RequestEntity");
import cookieParser = require("cookie-parser");
import setcookie = require("./common/setcookie");
import parseUser = require("./common/parseUser");
...
router.get("/myspace", function(req, res, next) {
	var user: userEntity.UserDto = new parseUser.parseUser(req).parse();
	var myboxItems: any[] = [];
	var boxItemQuery = {
		UserId: user.Id
	};
	...
	var items: any;//rander视图时的ppboxitems数据;
	var toMyBoxOption = {
...
router.get("/addppism", function(req, res, next) {
	...
	var userDtoR: any;//rander视图时的用户数据
	var items: any;//rander视图时的ppboxitems数据;
	//请求用户信息
	var toMyOption = {
